...
#define STRING_CONFIG_H_AUTHOR "(Stefan Kunter, SKR V1.4 TURBO Bear TMC2209/PINDA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR Turbo"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  28.17
    #define DEFAULT_Ki   2.41
    #define DEFAULT_Kd  82.40
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 30, 300 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 800, 180, 10000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 240, 20000 } // ...or, set your own edit limits
#endif
...
#define Z_PROBE_SPEED_FAST MYPROBE_SPEED_FAST

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW MYPROBE_SPEED_SLOW
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the number of grid points per dimension. //probe number of points
...
#define MYPROBE_SPEED_FAST (180*60)
#define MYPROBE_SPEED_SLOW (140*60)
